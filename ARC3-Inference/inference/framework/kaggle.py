...
def duck_kaggle_setup_command(config: DuckKaggleVllmConfig | None = None) -> str:
    ...
    replacements = {
        ...
        "__DEBRIEF_CONFIG__": repr(os.environ.get("DEBRIEF_CONFIG", "")),
        "__REFLECT_CONFIG__": repr(os.environ.get("REFLECT_CONFIG", "")),
...
setup_env = {
    ...
    'DEBRIEF_CONFIG': __DEBRIEF_CONFIG__,
    'REFLECT_CONFIG': __REFLECT_CONFIG__,
}
